...
const heroFacts = [
  ...
  "🏆 Cal AI Hacks sponsor prize winner",
...
const heroMetrics = [
  {
    value: "1st place",
    label: "Cal AI Hacks sponsor prize",
  },
  {
    value: "4B / month",
    label: "tokens spent building",
  },
  {
    value: "12B lifetime",
...
const proofStats = [
  {
    label: "Hackathon",
    value: "1st place",
    note: "sponsor prize at Cal AI Hacks",
  },
  {
    label: "Builder scale",
    value: "4B tokens / month",
    note: "12B lifetime across shipped experiments",
  },
  {
    label: "Cloak",
    value: "4 accelerators",
    note: "interviewed · now live at cloak.build",
  },
];
...
const featuredProjects = [
  {
    title: "Token Maxxing",
    meta: "AI systems • rapid iteration • execution",
    description: "A high-volume AI building practice: 4 billion tokens per month and 12 billion lifetime across products, systems, and experiments.",
    image: fooziImage,
  ...
  {
    title: "Cloak",
    meta: "live product • privacy • founder",
    description: "A consumer privacy-defense product interviewed by four accelerators and now live at cloak.build.",
    image: cloakImage,
    alt: "Cloak logo",
    href: "https://cloak.build/",
  },
];
...
export default function PortfolioPage() {
  ...
  return (
    <main className="portfolio-shell min-h-screen">
      ...
      <section className="portfolio-container mx-auto max-w-[1600px] px-5 py-6 md:px-8 md:py-8">
        ...
        <section className="hero-layout hero-grid mt-4">
          <div className="glass-panel hero-panel rounded-[1.4rem] p-5 md:p-6">
            ...
            <h1 className="hero-title hero-title-strong mt-3">I build products <span>across software, hardware, and AI.</span></h1>
            <p className="hero-copy hero-copy-strong mt-3 max-w-2xl">
              I’m a UC Berkeley mechanical engineering student who takes ideas from rough prototype to something real, useful, and ready to show people.
            </p>
          ...
          <div className="hero-side-stack">
            <aside className="glass-panel skills-panel rounded-[1.4rem] p-5 md:p-6">
              <div className="eyebrow mb-2">Working range</div>
              <h2 className="skills-title">Where I’m strongest</h2>
            ...
            {featuredProjects.map((project) => (
              <article key={project.title} className="project-visual-card">
                ...
                <div className="project-visual-content">
                  ...
                  {project.href && <a className="soft-link project-link" href={project.href} target="_blank" rel="noreferrer">Visit live product →</a>}
                </div>
              </article>
            ))}
          </div>
